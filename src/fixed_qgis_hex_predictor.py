...
OUTPUT_CSV = f"{project_directory}/punkty_pbc_wyniki_predykcji.csv"
...
if not warstwy:
    ...
    #                     nazwa_warstwy='punkty_pbc_wyniki_predykcji',
    #                     kolumny_int=['predicted_label'])
    # Sprawdź czy warstwa z wynikami już istnieje
    existing_result_layers = QgsProject.instance().mapLayersByName('punkty_pbc_wyniki_predykcji')
    ...
    if result_layer:
        ...
        apply_qml_style_to_layer(
            layer='punkty_pbc_wyniki_predykcji',
